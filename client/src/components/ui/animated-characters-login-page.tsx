  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between p-12" style={{ backgroundColor: "#f0f0f0", color: "#1a1a1a" }}>
        ...
        <div className="relative z-20 flex items-center gap-8 text-sm" style={{ color: "rgba(0,0,0,0.45)" }}>
          <a href="#" className="hover:opacity-100 transition-opacity" style={{ color: "rgba(0,0,0,0.45)" }}>
            Privacy Policy
          </a>
          <a href="#" className="hover:opacity-100 transition-opacity" style={{ color: "rgba(0,0,0,0.45)" }}>
            Terms of Service
      ...
      <div className="flex items-center justify-center p-8" style={{ backgroundColor: "#111111", color: "#f0f0f0" }}>
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-sm" style={{ color: "rgba(240,240,240,0.55)" }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                id="email"
                type="email"
                placeholder="admin@trueclaim.com"
                value={email}
                autoComplete="off"
                ...
                required
                className="h-12"
                style={{ backgroundColor: "#1e1e1e", border: "1px solid #333", color: "#f0f0f0" }}
              />
            </div>
            ...
            <Button
              ...
              size="lg"
              disabled={isLoading}
              style={{ backgroundColor: "#e8e8e8", color: "#111111", border: "none" }}
            >
          ...
          <div className="mt-6">
            <Button
              ...
              type="button"
              style={{ backgroundColor: "transparent", border: "1px solid #333", color: "#f0f0f0" }}
            >
